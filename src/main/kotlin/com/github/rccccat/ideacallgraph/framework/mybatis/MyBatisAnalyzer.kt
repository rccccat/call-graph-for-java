...
class MyBatisAnalyzer(
    ...
    private fun findXmlSqlFromIndex(method: PsiMethod): XmlSqlEntry? = findXmlEntryForMethod(method, logOnFailure = true)
    ...
    private fun isParameterTypeMatch(
        ...
        val primitiveFromWrapper = primitiveWrapperMap.entries.firstOrNull { it.value == entryType }?.key
