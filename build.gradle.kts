...
plugins {
  ...
  alias(libs.plugins.kover) // Gradle coverage plugin
}
...
dependencies {
  ...
  intellijPlatform {
    ...
    // Module Dependencies. Uses `platformBundledModules` property from the gradle.properties file
    // for bundled IntelliJ Platform modules.
...
// Configure Gradle coverage plugin - read more:
