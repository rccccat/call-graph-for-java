...
class JsonPreviewDialog(
    ...
    override fun createCenterPanel(): JComponent {
        ...
        // Add header label
        val headerLabel = JLabel("<html><b>Call Graph JSON for: $methodName</b><br/>You can copy this JSON to clipboard or select parts of it.</html>")
    ...
    override fun doOKAction() {
        ...
        com.intellij.notification.NotificationGroupManager.getInstance()
            ...
            .createNotification("JSON copied to clipboard", com.intellij.notification.NotificationType.INFORMATION)
            .notify(project)
